        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              <h1 className="text-base sm:text-base font-bold text-white tracking-tight shrink-0 hidden sm:block">
                FamilyNotes
              </h1>
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2 py-1 sm:px-2.5 rounded-lg bg-slate-800/90 hover:bg-slate-700 text-slate-200 hover:text-white text-xs font-bold border border-slate-700 transition cursor-pointer group shrink-0"
              >
      ...
      <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
        {syncConfig?.enabled && (
          <button
            ...
            className={`flex items-center gap-1.5 p-2 sm:px-3 sm:py-1.5 rounded-xl bg-slate-800/80 hover:bg-slate-800 text-xs font-medium border border-slate-700/60 transition disabled:opacity-50 cursor-pointer ${syncing ? "text-emerald-400" : "text-emerald-500 hover:text-emerald-400"}`}
          >
